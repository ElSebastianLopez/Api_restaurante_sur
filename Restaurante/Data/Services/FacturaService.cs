        ...
        public async Task<ResponseModel<List<FacturaDTO>>> GetAllFacturasAsync()
        {
            try
            {
                ...
                var facturaDTOs = facturas.Select(f => new FacturaDTO
                {
                    ...
                    NombreCliente = f.IdClienteNavigation != null ? $"{f.IdClienteNavigation.Nombres} {f.IdClienteNavigation.Apellidos}" : "",
                    NroMesa = f.NroMesa,
                    NombreMesa = f.NroMesaNavigation != null ? f.NroMesaNavigation.Nombre : "",
                    IdMesero = f.IdMesero,
                    NombreMesero = f.IdMeseroNavigation != null ? $"{f.IdMeseroNavigation.Nombres} {f.IdMeseroNavigation.Apellidos}" : "",
                    Fecha = f.Fecha,
                }).ToList();
